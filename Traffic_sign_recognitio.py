...
#         print(count, end=" ")
#     else:
#         print(f"Directory {folder_path} not found. Skipping this class.")
#     count += 1
...
############################### DISPLAY A BAR CHART SHOWING NO OF SAMPLES FOR EACH CATEGORY
# Ensure that num_of_samples matches the number of classes
while len(num_of_samples) < num_classes:
